  ...
  return (
    <footer className="bg-white shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-700">
      ...
      <div className="flex justify-center items-center space-x-1">
        <a
          href="https://docs.google.com/forms/d/e/1FAIpQLSfes3nzLaKvD6stB4rX0iP2WPp25YS_k1fYxTX2rHq2WbOGvw/viewform"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://github.com/orgs/fixmix-hackathon/repositories"
